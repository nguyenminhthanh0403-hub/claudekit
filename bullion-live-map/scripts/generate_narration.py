...
JOHNNY_TEMPO = 0.92  # ffmpeg atempo — ChatterboxTTS has no native rate control;
                     # history: 0.9 -> 0.95 (user review 2026-08-02, "Johnny is
                     # speaking too slow") -> 0.92 (2026-08-03, alongside the
                     # persona-vocabulary script rewrite, confirmed by ear on
                     # the "banks" sample).
...
JOHNNY_SCRIPTS = {
    "sec": "SEC. Supposed to be the cops on the beat, keeping the corpos honest. Half the time they're a step behind, chasing paper trails after the damage's already done. That's not incompetence — that's the budget they got approved for. Pull 'em out of the picture entirely and it's open season: little guy's holding a busted contract while the suits count their eddies.",
    "cftc": "CFTC. The badge that's supposed to police the derivatives grid — a market so big it makes the stock exchange look like a corner store. Six hundred trillion in notional paper changing hands, more zeroes than any gonk could actually picture. They watch the futures pits, split turf with the SEC on the weird hybrid stuff, and mostly show up after the fire's already out. Still better than nobody watching the wires.",
    ...
    "tsy": "US Treasury. Uncle Sam's credit line, and it's maxed at thirty-five trillion eddies and climbing. Sells IOUs every week — bills, notes, bonds — and the rate on that paper is the baseline hum underneath every other rate in the system. Mortgages, corporate debt, your credit card APR, all of it takes its cue from what the government pays to borrow. World's biggest, most trusted debtor. Funny how that works.",
    "fed": "They call it the Federal Reserve. I call it the biggest chrome-plated puppet show in the world — a room full of suits who print eddies out of thin air and decide who eats and who don't. Rates go up, rates go down, and every time some corpo uptown gets richer while the street picks up the tab. Not a glitch, choom — that's the system running exactly as designed. Keeps prices 'stable,' they say. Sure. Stable for them.",
    "fomc": "FOMC. Twelve people in a room, eight times a year, deciding whether your mortgage gets cheaper or your savings account finally earns something. They call it data-dependent. I call it a dozen suits staring at spreadsheets and guessing, same as the rest of us, just with better seats. The whole market holds its breath waiting on a vote most gonks can't name a single member of.",
    "ffr": "Fed Funds Rate. One number, and it runs the whole grid — mortgages, car loans, credit cards, business loans, all of it tuned off this single dial the Fed turns eight times a year. Overnight rate banks charge each other, sure, but the ripple never stops there. Turn it up, everything downstream gets more expensive. Turn it down, cheap money everywhere. Simple knob. Just wired to everything you own.",
    ...
    "mmf": "Money market funds. 'Safe as cash,' they tell you — six and a half trillion eddies parked in stuff that's supposed to never break. 'Supposed to' is doing a lot of work in that sentence. One of these funds broke the buck in '08 and damn near zeroed the whole short-term system. They're the quiet giant lending into repo every single night — pull that money out fast enough, and the lights start flickering everywhere else.",
    "hf": "Hedge funds. Suits playing with borrowed chips, four trillion and counting, betting big because somebody else's money makes the losses easier to swallow. Fine when it's calm — they grease the wheels, add a little liquidity. But when the trade goes bad and the margin calls hit, they all sell the same stuff at the same time, and calm turns into a stampede that zeroes accounts real fast. March 2020 taught that lesson loud.",
    ...
    "yield": "Yield curve. Line on a chart nobody looks at till it flips upside down — then suddenly everybody's screaming recession. Funny thing about the future: it's usually cheaper to borrow for than the present. When that flips, smart money thinks tomorrow's rough. Pay attention when it inverts. The suits sure do.",
    ...
    "equit": "Equity markets. Forty-five trillion parked in stocks, and every bit of it is a bet on tomorrow's profits discounted back to today. Crank up interest rates and that discount gets brutal — future eddies are worth less, so the whole market marks itself down. Same companies, same earnings, different math. Welcome to the casino where the house rules change every FOMC meeting.",
    "mbs": "Mortgage bond market. Fourteen trillion in bundled-up home loans, and this — not the Fed's headline rate — is what actually decides what you pay for a house. Tracks the ten-year Treasury plus whatever spread the suits feel like charging that week. The Fed even owned a couple trillion of this stuff at the peak, propping up the whole housing complex from behind the curtain.",
    ...
    "defn": "Defensive equities. Utilities, groceries, hospitals — the boring stuff nobody brags about owning, until the market gets scary and suddenly everybody wants a piece. Low beta, steady dividends, the financial equivalent of pulling the blinds and hiding indoors. Doesn't make you rich. Just keeps you from getting zeroed when everything else is bleeding.",
    ...
    "nfp": "Non-Farm Payrolls. First Friday of the month, one report, and it can swing the whole market before most people finish their coffee. Too many jobs added, and the suits start sweating inflation. Too few, and it's recession chatter on every screamsheet by lunch. A hundred and fifty-some million people's paychecks, reduced to one headline number everybody trades off of.",
    ...
    "dxy_fx": "Emerging market currencies. Poorer countries borrowed in dollars they don't print, and when the dollar rallies, that debt gets heavier without them spending a cent — five and a half trillion in exposure, just sitting there waiting for the exchange rate to turn against them. Ten percent dollar strength, roughly two points off their GDP, gone before anybody local can even react. Nobody in those countries voted for a Fed meeting, but they pay for it anyway.",
    "gold": "Gold. Ganic chrome, choom — no batteries, no code, can't be hacked, can't be printed. When the suits panic and the dollar starts bleeding out, everybody runs for the shiny rock like it's the last exit off a burning highway. Ironic, right? Most advanced economy on the planet, and when it all goes sideways, we're back to digging up shiny metal.",
    ...
    "geo": "Global trade. The rulebook — WTO, tariffs, the whole tangled web that decides what crossing a border costs. Twenty-five trillion a year in goods moving around the planet, and when that breaks down — tariffs jacked up, supply chains snapped — prices climb everywhere, not just at the border. Post-COVID alone reportedly tacked about a point onto global inflation. Nobody notices the rules until they get rewritten under you.",
    "deposits": "Bank deposits. Your checking account, your savings — feels like your eddies, sitting there. Legally, it's a debt the bank owes you, and most of the money that exists in this whole economy got created the moment some bank made a loan against it. Seventeen, eighteen trillion of it, insured up to a quarter million. Comforting number till everybody tries to pull it out at once, like Silicon Valley Bank found out.",
    "m2": "Money supply. M2 — cash, checking, savings, the whole spendable pool, twenty-one trillion deep. Grew forty percent in two years during the pandemic, then shrank for the first time since 1948. Print that much that fast and inflation usually shows up to collect, sooner or later. The connection's loose, but it's never really zero.",
...
EVENT_JOHNNY_SCRIPTS = {
    "rate_hike": "Rate hike, fifty basis points. Every loan in the country just got more expensive overnight, choom — and the tech stocks feel it worst, 'cause their whole story was cheap eddies.",
    ...
    "cpi_rise": "Inflation's running hot again, straight off the screamsheet. Markets don't even wait for the Fed anymore — they just price in the pain early.",
    "usd_shock": "Dollar's surging. Feels like a flex until you remember half the planet owes debt in the currency that just got more expensive to pay back — and no way to duck out of it.",
    ...
    "fiscal_stimulus": "Government's spending borrowed eddies again. Growth gets a jolt, but somebody's gotta buy all those new bonds — and that somebody wants a higher rate for the trouble.",
    "fiscal_tightening": "Debt ceiling standoff. Washington plays chicken with the full faith and credit of the whole system, and the market prices in the stupidity — not an accident, a choice, made by people who won't eat the consequences.",
    ...
    "deregulation": "Rules just got looser. Banks get to run hotter, profits climb — and somewhere down the line, that's exactly the kind of slack that snaps. Ask any gonk who called '08 an accident.",
